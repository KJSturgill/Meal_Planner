...
namespace MealPlanner
{
    class RiceMeals
    {
        public static List<Meal> ListRiceMeals()
        {
            ...
            result.Add(new Meal(5, "Risotto", new string[] { "veggie" }, "test, will add later"));
            result.Add(new Meal(6, "Tex Mex", new string[] { "veggie", "chicken", "turkey", "steak" }, "test, will add later"));
            result.Add(new Meal(7, "Jambalaya", new string[] { "veggie", "turkey", "shrimp", "chicken", "sausage" }, "test, will add later"));
